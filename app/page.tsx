        ...
        <div className="grid-cols-1 w-full mx-auto">
          <div className="text-neutral-100 text-center   ">
            ...
            <div className="text-center">
              <p className="font-thin md:text-[1.25rem] text-xs max-w-[400px]  text-neutral-100  mt-2 mx-auto text-justify">A honlapot azzal a céllal készítettem, hogy bemutassam Kemenesalja nevezetes helyeit, és híres személyeit, mind ezt egy jól kinéző letisztult design-nal megáldva. </p>
